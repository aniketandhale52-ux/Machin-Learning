...
2. Checks required features.
3. Applies the saved scaler.
4. Generates predictions using the trained KNN model.
5. Adds a `Predicted_Sales` column.
6. Displays summary metrics.
7. Shows a prediction distribution chart.
8. Allows the user to download the prediction results.
